...
def main():
    try:
        ...
        for i in range(1, 11):
            ...
            # results_df = all_results_df.drop_duplicates(['FirstLastDomain', 'FirstLastCompany'])
            ...
            try:
                ...
                try:
                    if mapped_fourth_conditions:
                        all_results_df = all_results_df[
                            all_results_df['Employee_Size'].isin(mapped_fourth_conditions)]
                except Exception as e:
                ...
                try:
                    ...
                    if email_conditions:
                        ...
                        all_results_df = all_results_df[
                            ~all_results_df['Email'].isin(email_conditions)].drop_duplicates(
                            'Email')
                except Exception as e:
